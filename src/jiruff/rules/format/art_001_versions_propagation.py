...
class FormatArt001Config(BaseModel):
...
class FormatArt001VersionPropagation:
    rule_key: Literal["art-001"] = "art-001"
    ...
    def __init__(self, jira: JiraService, rule_config: dict[str, str] | None = None) -> None:
        ...
        self.rule_config = FormatArt001Config(**rule_config_dict)

    def run(self) -> None:
        """
        Run the version propagation for ART-001.
        """
        logger.info("Running ART-001 version propagation formatter rule.")
